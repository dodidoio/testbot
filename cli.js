...
function showFormat(){
	[
		...
		"\t.param param-name param-value. Can you handlebars template for param value",
		...
		"\tlines not starting with dot are sent to the bot as an outgoing message. Lines are treated as handlebars template with params as the object containing the properties",
		"\tlines starting with tab represent expected response. Can use handlebars templates",
		"\t/expected response regular expression/ - the match is stored in params as `regex`",
